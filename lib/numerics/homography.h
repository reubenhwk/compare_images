...
/// Homography (and more restricted transforms) estimation.
 ...
 public:
		...
		void add(float x1, float y1, float x2, float y2, float w =
			 1.0f);
 ...
 private:
		...
		void add_4parameters(float x1, float y1, float x2, float y2,
				     float w);
		void add_4parameters(float a1, float b1, float c1, float a2,
				     float b2, float c2, float w);
