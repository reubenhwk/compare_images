...
template < typename T > matrix < T > cat(const matrix < T > &,
					 const matrix < T > &);
...
/// Matrix class
 ...
 public:
		...
		friend matrix < T > cat < T > (const matrix < T > &left,
		...
		template < typename U > void read(const U * v);
...
template < typename T >
inline std::ostream & operator<<(std::ostream & out, const libNumerics::matrix < T > &m)
{
...
template < typename T >
    T dot(const libNumerics::vector < T > &u,
	  const libNumerics::vector < T > &v);
template < typename T > libNumerics::vector < T >
cross(const libNumerics::vector < T > &u, const libNumerics::vector < T > &v);
