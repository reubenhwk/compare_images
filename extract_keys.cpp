...
static void stream_keys_in(std::ifstream &file1, int &num_keys1, double &zoom1, vector < vector < keypointslist > > &keys1)
{
	int version;
	file1 >> version;
...
static void stream_keys_out(std::ofstream &file1, int num_keys1, double zoom1, vector < vector < keypointslist > > &keys1)
{
